...
const ParallaxNotebook = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      // Adjust values for mobile vs desktop
      const startOpen = isMobile ? viewportHeight * 0.7 : viewportHeight * 0.8;
      const fullyOpen = isMobile ? viewportHeight * 0.3 : viewportHeight * 0.5;
        ...
        <div className="max-w-5xl mx-auto">
          ...
          >
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-background/90 via-background/40 to-transparent">
                      <div className="absolute bottom-0 left-0 right-0 p-3 md:p-6">
                        ...
                        <div className="flex items-center gap-2 mb-2 md:mb-3">
                          <div className="w-4 h-4 md:w-8 md:h-8 bg-primary rounded-md flex items-center justify-center">
                            <Play className="w-2 h-2 md:w-4 md:h-4 text-primary-foreground fill-current" />
                          </div>
                          <span className="font-display text-xs md:text-lg text-foreground">
                            EURO<span className="text-primary">PLAYO</span>
                          </span>
                        </div>
                        
                        {/* Featured info */}
                        <h3 className="font-display text-sm md:text-2xl text-foreground mb-1">
            ...
            >
              ...
              <div className="absolute top-2 left-4 md:left-6">
                <span className="text-[5px] md:text-[6px] text-zinc-500 font-mono tracking-wider">EUROPLAYO</span>
              </div>
            </div>
          ...
          >
            {[
              ...
              <div
                key={i}
                className="text-center p-4 md:p-6 rounded-xl glass-effect hover-lift"
              >
                <feature.icon className="w-8 h-8 md:w-10 md:h-10 text-primary mx-auto mb-3 md:mb-4" />
