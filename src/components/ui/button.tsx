  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-body",
  {
    variants: {
      variant: {
        ...
        hero: "bg-primary text-primary-foreground font-semibold uppercase tracking-wider hover:bg-primary/90 hover:shadow-[0_0_40px_hsl(var(--primary)/0.6)] hover:scale-105 transition-all duration-300",
        glass: "bg-background/20 backdrop-blur-md border border-border/50 text-foreground hover:bg-background/30 hover:border-primary/50",
        glow: "bg-primary text-primary-foreground animate-pulse-glow hover:animate-none hover:shadow-[0_0_50px_hsl(var(--primary)/0.8)]",
      },
      size: {
